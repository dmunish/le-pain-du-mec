        ...
        <div className="max-w-7xl mx-auto animate-fade-in">
          {!isSimulationActive() ? (
            ...
            <div className="flex flex-col space-y-4 sm:space-y-6">
              ...
              {/* Stats and controls below the map */}
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-2">
                      <div className="glass p-3 rounded-lg">
                        ...
                        <p className="text-white text-lg font-medium">{stats.totalAgents.toLocaleString()}</p>
                      </div>
                      ...
                      <div className="glass p-3 rounded-lg">
                        ...
                        <p className="text-accent-orange text-lg font-medium">
                          {stats.infectedAgents.toLocaleString()}
                        </p>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <GlassCard title="Disease Metrics" variant="light">
                    <div className="space-y-4">
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center">
                            <Thermometer className="h-4 w-4 text-accent-orange mr-2" />
                            <span className="text-sm text-white">R₀ Value</span>
                          </div>
                          <span className="text-sm font-medium text-white">2.4</span>
                        </div>
                        <div className="h-2 bg-bg-dark/50 rounded-full overflow-hidden">
                          <div
                            className="h-2 bg-accent-orange rounded-full"
                            style={{ width: `${(2.4 / 5) * 100}%` }}
                          ></div>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center">
                            <Droplets className="h-4 w-4 text-accent-orange mr-2" />
                            <span className="text-sm text-white">Infection Rate</span>
                          </div>
                          <span className="text-sm font-medium text-white">
                            {((stats.infectedAgents / stats.totalAgents) * 100).toFixed(1)}%
                          </span>
                        </div>
                        <div className="h-2 bg-bg-dark/50 rounded-full overflow-hidden">
                          <div
                            className="h-2 bg-accent-orange rounded-full"
                            style={{ width: `${(stats.infectedAgents / stats.totalAgents) * 100}%` }}
                          ></div>
                        </div>
                      </div>
                    </div>
